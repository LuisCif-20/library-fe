  ...
  const s = (r) => {
    ...
    for (let a = 0; a < o; a++) {
      ...
      if (u && Array.isArray(u)) s(u);
        ...
        const i = typeof u;
        if (u == null || i === "function" || i === "boolean") continue;
...
function de(e, t, n, s, r) {
  const {
    ...
    type: n
  }, c = o?.name === x && o.map, d = i != null ? o == Function || !T(i) ? () => i : i : null;
  Object.defineProperty(e, t, {
    ...
    set(f) {
      ...
      if (E && g != null) throw new jt(this, `The value defined for prop '${t}' must be of type '${o.name}'`, g);
...
var me = (e, t, n, s) => s == null || t == Boolean && !s ? e.removeAttribute(n) : e.setAttribute(n, t?.name === x && t?.serialize ? t?.serialize(s) : R(s) ? JSON.stringify(s) : t == Boolean ? "" : s);
...
var j = (e, t = HTMLElement) => {
  const n = {}, s = {}, r = "prototype" in t && t.prototype instanceof Element, o = r ? t : "base" in t ? t.base : HTMLElement, {
    props: a,
    styles: u
  } = r ? e : t;
  class i extends o {
...
var P = (e, t = {}) => {
  const n = _();
  return n[e] || (n[e] = (s = t.detail) => Yt(n.current, __spreadProps(__spreadValues({
    type: e
  }, t), {
    detail: s
  }))), n[e];
...
var Ht = (e, t, ...n) => {
  ...
  if (o === false && e instanceof Function) return e(r != rt ? __spreadValues({
    children: r
  }, s) : s);
...
function Kt(e, t, n = Ce, s, r) {
  ...
  (e || !t) && (r = r || e.type == "svg", o = e.type != "host" && (e.raw == 1 ? (t && e.clone ? t[X] : t) != e.type : e.raw == 2 ? !(t instanceof e.type) : t ? t[X] || t.localName != e.type : !t), o && e.type != null && (e.raw == 1 && e.clone ? (s = true, t = e.type.cloneNode(true), t[X] = e.type) : t = e.raw == 1 ? e.type : e.raw == 2 ? new e.type() : r ? document.createElementNS("http://www.w3.org/2000/svg", e.type) : document.createElement(e.type, e.is ? {
    is: e.is
  } : void 0)));
  const a = t[n] ? t[n] : q, {
    vnode: u = q,
  ...
  t.attachShadow(__spreadValues({
    mode: "open"
  }, e.shadow)), e.props != f && Me(t, f, e.props, c, r), e.children !== d) {
...
function St(e, t, n, s, r, o) {
  if (t = t == "class" && !r ? "className" : t, n = n ?? null, s = s ?? null, t in e && Se[t] && (n = e[t]), !(s === n || Te[t] || t[0] == "_")) if (t[0] == "o" && t[1] == "n" && (T(s) || T(n))) Ae(e, t.slice(2), s, o);
    ...
    a === t && (!r && !we[t] && t in e || T(s) || T(n)) ? e[t] = s ?? "" : s == null ? e.removeAttribute(a) : e.setAttribute(a, R(s) ? JSON.stringify(s) : s);
  }
}
function Ae(e, t, n, s) {
...
var v = class _v {
  ...
  add(t) {
    const n = w(this);
    if ("days" in t) return n.setUTCDate(this.day + t.days), _v.from(n);
    let {
      year: s,
      month: r
    } = this;
  ...
  static from(t) {
    if (typeof t == "string") {
      ...
      const [, s, r, o] = n;
      return new _v(parseInt(s, 10), parseInt(r, 10), parseInt(o, 10));
    }
    return new _v(t.getUTCFullYear(), t.getUTCMonth() + 1, t.getUTCDate());
  }
};
var W = class _W {
  constructor(t, n) {
...
function L(e, t) {
  return C(() => new Intl.DateTimeFormat(t, __spreadValues({
    timeZone: "UTC"
  }, e)), [t, e]);
}
function Ct(e, t, n) {
...
function Ke({
  ...
  const {
    ...
    weekday: d
  }), [d]), g = Ct(E, s, l), y = L(xe, l), h = L(ze, l), S = C(() => i.start.add({
    months: n
  }), [i, n]), J = C(() => je(S, s), [S, s]), Gt = P("focusday", V), Qt = P("selectday", V), Vt = P("hoverday", V);
  function pt(b) {
    Gt(K(b, o, a));
  }
  function te(b) {
  ...
  function ee(b) {
    ...
    } else t.type === "multi" ? k = t.value.some((F) => F.equals(b)) : k = t.value?.equals(b);
    return {
...
var Je = j((e) => {
        ...
        children: s.weeks.map((o, a) => /* @__PURE__ */ p("tr", {
          ...
          children: o.map((u, i) => {
            ...
            return /* @__PURE__ */ p("td", {
              part: "td",
              children: l && /* @__PURE__ */ p("button", __spreadProps(__spreadValues({}, l), {
                children: u.day
              }))
            }, i);
          })
  ...
  styles: [Wt, Jt, H`:host{--color-accent: black;--color-text-on-accent: white;display:flex;flex-direction:column;gap:.25rem;text-align:center;inline-size:fit-content}table{border-collapse:collapse;font-size:.875rem}th{font-weight:700;block-size:2.25rem}td{padding-inline:0}button{color:inherit;font-size:inherit;background:transparent;border:0;font-variant-numeric:tabular-nums;block-size:2.25rem;inline-size:2.25rem}button:hover:where(:not(:disabled,[aria-disabled])){background:#0000000d}button:is([aria-pressed=true],:focus-visible){background:var(--color-accent);color:var(--color-text-on-accent)}button:focus-visible{outline:1px solid var(--color-text-on-accent);outline-offset:-2px}button:disabled,:host::part(outside),:host::part(disallowed){cursor:default;opacity:.5}`]
});
...
var mt = [Wt, Jt, H`:host{display:block;inline-size:fit-content}[role=group]{display:flex;flex-direction:column;gap:1em}:host::part(header){display:flex;align-items:center;justify-content:space-between}:host::part(heading){font-weight:700;font-size:1.25em}button{display:flex;align-items:center;justify-content:center}button[aria-disabled]{cursor:default;opacity:.5}`];
var Ze = {
  year: "numeric"
};
var Xe = {
...
function Ge({
  ...
  const a = e === "single" ? 1 : n, [u, i] = ct(() => Ot(t.toPlainYearMonth(), n)), l = (d) => i(Ot(u.start.add({
    months: d
  }), n)), c = (d) => {
...
function yt({
  ...
  const [o] = N("min"), [a] = N("max"), [u] = N("today"), i = P("focusday"), l = P("change"), c = C(() => K(s ?? u ?? lt(), o, a), [s, u, o, a]);
  function d(h) {
    r(h), i(w(h));
  }
  const {
...
var Qe = j((e) => {
  const [t, n] = N("value"), [s = t, r] = N("focusedDate"), o = yt(__spreadProps(__spreadValues({}, e), {
    focusedDate: s,
    setFocusedDate: r
  }));
  function a(u) {
  ...
  return /* @__PURE__ */ p("host", {
    shadowDom: true,
    focus: o.focus,
    children: /* @__PURE__ */ p(dt, __spreadProps(__spreadValues(__spreadValues({}, e), o), {
      type: "date",
      value: t,
      onSelect: a
    }))
...
var Ve = j((e) => {
  const [t, n] = Be("value"), [s = t[0], r] = N("focusedDate"), o = yt(__spreadProps(__spreadValues({}, e), {
    focusedDate: s,
    setFocusedDate: r
  ...
  props: __spreadProps(__spreadValues({}, ht), {
    tentative: {
      type: String,
      value: ""
    }
...
var tn = j((e) => {
  const [t, n] = qe("value"), [s = t[0], r] = N("focusedDate"), o = yt(__spreadProps(__spreadValues({}, e), {
    focusedDate: s,
    setFocusedDate: r
  }));
  function a(u) {
...
// src/app/forms/components/date-input/date-input.component.ts
var _c0 = ["calendarPopover"];
var _c1 = (a0) => ({ "text-error": a0 });
var _c2 = (a0) => ({ "input-error": a0 });
function DateInputComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
var DateInputComponent = class _DateInputComponent {
  ...
  max = input("");
  min = input("");
  calendarPopover = viewChild.required("calendarPopover");
  openCalendar() {
  ...
  static \u0275fac = function DateInputComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DateInputComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DateInputComponent, selectors: [["date-input"]], viewQuery: function DateInputComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuerySignal(ctx.calendarPopover, _c0, 5);
    }
    if (rf & 2) {
      \u0275\u0275queryAdvance();
    }
  }, inputs: { control: [1, "control"], legend: [1, "legend"], label: [1, "label"], max: [1, "max"], min: [1, "min"] }, decls: 13, vars: 11, consts: [["calendarPopover", ""], [1, "fieldset"], [1, "fieldset-legend", 3, "ngClass"], ["type", "text", "readonly", "", "placeholder", "yyyy-mm-dd", 1, "input", 3, "click", "ngClass", "formControl"], ["popover", "", 1, "bg-base-200", "rounded-box", "shadow-lg", "center-popover"], [1, "cally", 3, "change", "max", "min"], ["slot", "previous", 1, "material-icons"], ["slot", "next", 1, "material-icons"], [1, "fieldset-label", "text-error", "text-[8px]"]], template: function DateInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function DateInputComponent_Template_input_click_3_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openCalendar());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 4, 0)(6, "calendar-date", 5);
      \u0275\u0275listener("change", function DateInputComponent_Template_calendar_date_change_6_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(10, "arrow_right");
      \u0275\u0275elementEnd();
      \u0275\u0275element(11, "calendar-month");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(12, DateInputComponent_Conditional_12_Template, 2, 1, "p", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(7, _c1, ctx.isInvalid));
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(ctx.legend());
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(9, _c2, ctx.isInvalid))("formControl", ctx.control());
      \u0275\u0275advance(3);
      \u0275\u0275property("max", ctx.max())("min", ctx.min());
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx.label() && ctx.isInvalid ? 12 : -1);
    }
  }, dependencies: [
    NgClass,
    ReactiveFormsModule,
    ...
    NgControlStatus,
    FormControlDirective
  ], styles: ["\n\n.center-popover[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 50;\n}\n/*# sourceMappingURL=date-input.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DateInputComponent, { className: "DateInputComponent", filePath: "src/app/forms/components/date-input/date-input.component.ts", lineNumber: 21 });
})();

export {
  DateInputComponent
};
//# sourceMappingURL=chunk-I5YV25LT.js.map
