...
// src/app/library/components/search-input/search-input.component.ts
var SearchInputComponent = class _SearchInputComponent {
  ...
  ngOnInit() {
    this.subs = this.searchControl.valueChanges.pipe(debounceTime(500)).subscribe({
      next: (value) => {
  ...
  static \u0275fac = function SearchInputComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SearchInputComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchInputComponent, selectors: [["search-input"]], decls: 4, vars: 1, consts: [[1, "input", "rounded-full", "w-[20rem]"], [1, "material-icons"], ["type", "search", "required", "", "placeholder", "Busca por codigo, ISBN o nombre...", 3, "formControl"]], template: function SearchInputComponent_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [ReactiveFormsModule, DefaultValueAccessor, NgControlStatus, RequiredValidator, FormControlDirective], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchInputComponent, { className: "SearchInputComponent", filePath: "src/app/library/components/search-input/search-input.component.ts", lineNumber: 15 });
})();
...
var SliderComponent = class _SliderComponent {
  ...
  normaliseModelValues(input2) {
    const normalisedInput = new ModelValues();
    normalisedInput.value = input2.value;
    normalisedInput.highValue = input2.highValue;
    ...
    if (this.viewOptions.enforceRange) {
      ...
      if (this.range && input2.value > input2.highValue) {
        if (this.viewOptions.noSwitching) {
          normalisedInput.value = normalisedInput.highValue;
        } else {
          const tempValue = input2.value;
          normalisedInput.value = input2.highValue;
...
// src/app/library/components/book-filters-modal/book-filters-modal.component.ts
function BookFiltersModalComponent_Conditional_4_For_24_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("formControlName", $index_r4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(author_r3.label);
  }
}
function BookFiltersModalComponent_Conditional_4_For_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275element(1, "input", 19);
    \u0275\u0275elementStart(2, "span", 20);
  ...
  if (rf & 2) {
    const publisher_r5 = ctx.$implicit;
    const $index_r6 = ctx.$index;
    \u0275\u0275advance();
    \u0275\u0275property("formControlName", $index_r6);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(publisher_r5.label);
  }
}
function BookFiltersModalComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-modal", 2);
    \u0275\u0275listener("closeModal", function BookFiltersModalComponent_Conditional_4_Template_app_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showModal.set(false));
    });
    \u0275\u0275elementStart(1, "form", 3);
    \u0275\u0275listener("ngSubmit", function BookFiltersModalComponent_Conditional_4_Template_form_ngSubmit_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(7, "Existencias:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "ngx-slider", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 6)(10, "span", 7);
    \u0275\u0275text(11, "Disponibles:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(12, "ngx-slider", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 10)(14, "span", 7);
    \u0275\u0275text(15, "Elige un rango de precio:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(16, "ngx-slider", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275element(17, "date-input", 12)(18, "date-input", 13);
    \u0275\u0275elementStart(19, "div", 14)(20, "span", 7);
    \u0275\u0275text(21, "Autores:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 15);
    \u0275\u0275repeaterCreate(23, BookFiltersModalComponent_Conditional_4_For_24_Template, 4, 2, "div", 16, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 14)(26, "span", 7);
    \u0275\u0275text(27, "Editoriales:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div", 17);
    \u0275\u0275repeaterCreate(29, BookFiltersModalComponent_Conditional_4_For_30_Template, 4, 2, "div", 16, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "button", 18);
    \u0275\u0275text(32, " Aplicar Filtros ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("options", ctx_r1.quantityOptions());
    \u0275\u0275advance(4);
    \u0275\u0275property("options", ctx_r1.quantityOptions());
    \u0275\u0275advance(4);
    \u0275\u0275property("options", ctx_r1.priceOptions());
    \u0275\u0275advance();
    \u0275\u0275property("control", ctx_r1.filtersForm.controls.publicationStartDate)("max", ctx_r1.filtersForm.controls.publicationEndDate.value);
    \u0275\u0275advance();
    \u0275\u0275property("control", ctx_r1.filtersForm.controls.publicationEndDate)("min", ctx_r1.filtersForm.controls.publicationStartDate.value);
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r1.authors());
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r1.publishers());
    \u0275\u0275advance(2);
...
var BookFiltersModalComponent = class _BookFiltersModalComponent {
  formBuilder = inject(NonNullableFormBuilder);
  ...
  authors = signal([]);
  publishers = signal([]);
  priceOptions = signal(__spreadValues({
    floor: 0,
    ceil: 1e3,
    translate: (value) => {
      return "Q " + value;
  ...
  quantityOptions = signal(__spreadValues({
    floor: 1,
    ceil: 50
  }, OPTIONS));
  ...
  getSelectedOptions(items, selected) {
    return selected.map((value, index) => {
      return value ? items[index].value : null;
    }).filter((value) => value !== null);
  }
  prepareFilters() {
    const _a = this.filtersForm.getRawValue(), { price, quantity, availableCopies, authors, publishers } = _a, dates = __objRest(_a, ["price", "quantity", "availableCopies", "authors", "publishers"]);
  ...
  static \u0275fac = function BookFiltersModalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BookFiltersModalComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookFiltersModalComponent, selectors: [["book-filters-modal"]], decls: 5, vars: 1, consts: [["hoverStyle", "", 1, "btn", "rounded-full", "bg-yb", "text-white", "hover:bg-yb/90", 3, "click"], [3, "fullWidth", "fullHeight"], [3, "closeModal", "fullWidth", "fullHeight"], ["body", "", 1, "flex", "flex-col", "max-h-full", "overflow-y-auto", 3, "ngSubmit", "formGroup"], [1, "flex-none", "font-bold", "text-3xl", "text-center", "my-5"], [1, "grow", "grid", "grid-cols-1", "md:grid-cols-2", "overflow-y-auto"], [1, "col-span-full", "md:col-span-1", "flex", "flex-col", "m-3"], [1, "mb-2"], ["formControlName", "quantity", 1, "mt-2", 3, "options"], ["formControlName", "availableCopies", 1, "mt-2", 3, "options"], [1, "col-span-full", "flex", "flex-col", "m-3"], ["formControlName", "price", 1, "mt-2", 3, "options"], ["legend", "Fecha de Publicacion Inicial:", 1, "m-3", "col-span-full", "md:col-span-1", 3, "control", "max"], ["legend", "Fecha de Publicacion Final:", 1, "m-3", "col-span-full", "md:col-span-1", 3, "control", "min"], [1, "m-3", "col-span-full", "md:col-span-1"], ["formArrayName", "authors", 1, "h-[95px]", "overflow-y-auto"], [1, "flex", "flex-row", "items-center"], ["formArrayName", "publishers", 1, "h-[95px]", "overflow-y-auto"], ["type", "submit", 1, "mx-auto", "mt-5", "btn", "bg-yb", "hover:bg-yb/85", "text-white", 3, "disabled"], ["type", "checkbox", 1, "checkbox", "checkbox-primary", "checkbox-sm", 3, "formControlName"], [1, "truncate", "ml-2"]], template: function BookFiltersModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "button", 0);
      \u0275\u0275listener("click", function BookFiltersModalComponent_Template_button_click_0_listener() {
      ...
      \u0275\u0275text(3, " Filtrar\n");
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, BookFiltersModalComponent_Conditional_4_Template, 33, 11, "app-modal", 1);
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookFiltersModalComponent, { className: "BookFiltersModalComponent", filePath: "src/app/library/components/book-filters-modal/book-filters-modal.component.ts", lineNumber: 34 });
})();

// src/app/library/components/book-card/book-card.component.ts
var BookCardComponent = class _BookCardComponent {
  AWS_URL = `${environment.AWS_URL}`;
  book = input.required();
  src = computed(() => `${this.AWS_URL}/${this.book().imageUrl}`);
  link = computed(() => `../books/${this.book().id}`);
  static \u0275fac = function BookCardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BookCardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookCardComponent, selectors: [["book-card"]], inputs: { book: [1, "book"] }, decls: 15, vars: 6, consts: [[1, "card", "bg-base-200", "h-full", "w-full", "shadow-md"], [1, "h-48", "overflow-hidden"], [1, "h-full", "object-cover", "object-center", 3, "src", "alt"], [1, "card-body"], [1, "badge", "badge-xs", "badge-secondary", "truncate"], [1, "card-title"], [1, "card-actions", "justify-end"], ["hoverStyle", "", 1, "btn", "btn-primary", 3, "routerLink"]], template: function BookCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "div", 6)(11, "button", 7)(12, "span");
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("src", ctx.src(), \u0275\u0275sanitizeUrl)("alt", ctx.book().title);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.book().author);
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookCardComponent, { className: "BookCardComponent", filePath: "src/app/library/components/book-card/book-card.component.ts", lineNumber: 16 });
})();

// src/app/library/components/add-book-modal/add-book-modal.component.ts
function AddBookModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "book-modal", 5);
    \u0275\u0275listener("closeModal", function AddBookModalComponent_Conditional_8_Template_book_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showModal.set(false));
    })("saveBook", function AddBookModalComponent_Conditional_8_Template_book_modal_saveBook_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.getBooks());
    });
    \u0275\u0275elementEnd();
  }
}
var AddBookModalComponent = class _AddBookModalComponent {
  booksStore = inject(BooksStore);
  getBooks = rxMethod(pipe(switchMap(() => this.booksStore.getBooks())));
  showModal = signal(false);
  static \u0275fac = function AddBookModalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AddBookModalComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddBookModalComponent, selectors: [["add-book-modal"]], decls: 9, vars: 1, consts: [[1, "card", "bg-base-200", "h-full", "w-full", "shadow-md"], [1, "card-body", "h-full", "w-full"], [1, "flex", "flex-col", "justify-center", "items-center", "h-full", "w-full"], [1, "font-bold", "text-2xl", "text-center"], ["hoverStyle", "", 1, "btn", "btn-secondary", "btn-circle", "mt-5", "scale-110", 3, "click"], [3, "closeModal", "saveBook"]], template: function AddBookModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
      \u0275\u0275text(4, "Agregar Libro");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "button", 4);
      \u0275\u0275listener("click", function AddBookModalComponent_Template_button_click_5_listener() {
        return ctx.showModal.set(true);
      });
      \u0275\u0275elementStart(6, "span");
      \u0275\u0275text(7, "library_add");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(8, AddBookModalComponent_Conditional_8_Template, 1, 0, "book-modal");
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
      \u0275\u0275conditional(ctx.showModal() ? 8 : -1);
    }
  }, dependencies: [
    HoverStyleDirective,
    BookModalComponent
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddBookModalComponent, { className: "AddBookModalComponent", filePath: "src/app/library/components/add-book-modal/add-book-modal.component.ts", lineNumber: 17 });
})();

// src/app/library/components/book-list/book-list.component.ts
function BookListComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275element(1, "add-book-modal");
    \u0275\u0275elementEnd();
  }
}
...
var BookListComponent = class _BookListComponent {
  ...
  static \u0275fac = function BookListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BookListComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookListComponent, selectors: [["book-list"]], decls: 4, vars: 1, consts: [[1, "grid", "grid-cols-1", "md:grid-cols-4"], [1, "m-2"], [3, "book"]], template: function BookListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, BookListComponent_Conditional_1_Template, 2, 0, "div", 1);
      \u0275\u0275repeaterCreate(2, BookListComponent_For_3_Template, 2, 1, "div", 1, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isLibrarian() ? 1 : -1);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookListComponent, { className: "BookListComponent", filePath: "src/app/library/components/book-list/book-list.component.ts", lineNumber: 16 });
})();

// src/app/library/pages/books-page/books-page.component.ts
var BooksPageComponent = class _BooksPageComponent {
  booksStore = inject(BooksStore);
  getBooks = rxMethod(pipe(switchMap(() => this.booksStore.getBooks())));
  page = computed(() => this.booksStore.filters().page);
  size = computed(() => this.booksStore.filters().size);
  constructor() {
  }
  ngOnInit() {
    this.getBooks();
  ...
  static \u0275fac = function BooksPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BooksPageComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BooksPageComponent, selectors: [["app-books-page"]], decls: 7, vars: 4, consts: [[1, "flex", "flex-col", "h-full"], [1, "mx-auto", "mt-10", "mb-5"], [1, "mx-auto"], [1, "flex", "flex-row", "justify-between", "m-5"], [3, "setSize", "size"], [3, "next", "previous", "page", "hasNext", "hasPrevious"], [1, "mx-3"]], template: function BooksPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "search-input", 1)(2, "book-filters-modal", 2);
      \u0275\u0275elementStart(3, "div", 3)(4, "items-per-page", 4);
      \u0275\u0275listener("setSize", function BooksPageComponent_Template_items_per_page_setSize_4_listener($event) {
        return ctx.changeSize($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "app-pagination", 5);
      \u0275\u0275listener("next", function BooksPageComponent_Template_app_pagination_next_5_listener() {
        return ctx.changePage(1);
      })("previous", function BooksPageComponent_Template_app_pagination_previous_5_listener() {
        return ctx.changePage(-1);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275element(6, "book-list", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("page", ctx.page())("hasNext", ctx.booksStore.hasNext())("hasPrevious", ctx.booksStore.hasPrevious());
    }
  }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BooksPageComponent, { className: "BooksPageComponent", filePath: "src/app/library/pages/books-page/books-page.component.ts", lineNumber: 25 });
})();
export {
